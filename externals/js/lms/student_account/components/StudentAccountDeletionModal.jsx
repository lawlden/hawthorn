...
class StudentAccountDeletionConfirmationModal extends React.Component {
  ...
  handleConfirmationModalClose() {
    ...
    window.location.href = 'http://10.211.55.98';
  }
  ...
  renderConfirmationModal() {
    ...
    const loseAccessText = StringUtils.interpolate(
      gettext('You will lose access to certificates and other program credentials. If you want to make a copy of these for your records before proceeding with deletion, follow the instructions for {htmlStart}printing or downloading a certificate{htmlEnd}.'),
      {
              ...
              <StatusAlert
                dialog={(
                  <div className="modal-alert">
                    ...
                    <div className="alert-content">
                      <h3 className="alert-title">{ gettext('You have selected “Delete my account.” Deletion of your account and personal data is permanent and cannot be undone. Enstructo will not be able to recover your account or the data that is deleted.') }</h3>
